...
import 'widgets/payment_type_form_modal/payment_type_form_modal.dart';
...
class _PaymentTypePageState extends State<PaymentTypePage> with Loader, Messages {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final filterDispose = reaction((_) => controller.filterEnabled, (_) {
      ...
      disposers.addAll([statusDisposer, filterDispose]);
      controller.loadPayments();
    });
  }
